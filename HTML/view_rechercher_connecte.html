		...
		<!-- Header -->
				<header id="header">
					<div id="hautheader">
						...
						<input type="submit" id='btnConnexion' value='DECONNEXION'>
					...
					<div>
	 			     ...
	 			     <div class="container">
	 			       <ul class="links">
	 			           <li><a href="../HTML/view_accueil_connecte.html" class ="active">ACCUEIL</a></li>
	 			           <li><a href="../HTML/view_rechercher_connecte.html">RECHERCHER</a></li>
	 			           <li><a href="../HTML/view_publier.html">PUBLIER</a></li>
									 <li><a href="../HTML/view_profil.html">PROFIL</a></li>
	 			       </ul>
	 			     </div>
 			     </nav>
					</div>
			...
			<section id="main">
				...
				<article>
					...
					<footer id="commentaires">
						...
						<input type="button" id='btnNoter' value='Noter'>
					</footer>
				</article>
			</section>
